...
usuario1 = User.new(
  ...
  dni: "98989880", address: "Av. Larco 1711", city: "Trujillo", email: "anaperez@gmail.com", password: "123456", business_name: "Perez Store"
)
...
usuario2 = User.new(
  ...
  dni: "46644648", address: "Av. El Golf 244", city: "Trujillo", email: "jdiaz@gmail.com", password: "123456", business_name: "Diaz Corp SA"
)
photo = URI.open("https://cdn-icons-png.flaticon.com/512/1/1247.png")
...
usuario3 = User.new(
  ...
  dni: "46677648", address: "Av. Flora Tristan 324", city: "Lima", email: "jhons@gmail.com", password: "123456"
)
photo = URI.open("https://cdn-icons-png.flaticon.com/512/1/1247.png")
...
usuario4 = User.new(
  ...
  dni: "46644827", address: "Av el golf de los incas 488", city: "Surco", email: "alexaji@gmail.com", password: "123456"
)
photo = URI.open("https://cdn-icons-png.flaticon.com/512/1/1247.png")
...
usuario5 = User.new(
  ...
  dni: "46622648", address: "Calle Geranios 311", city: "Arequipa", email: "mromero2@gmail.com", password: "1234567"
)
photo = URI.open("https://cdn-icons-png.flaticon.com/512/1/1247.png")
...
usuario6 = User.new(
  ...
  dni: "43434548", address: "Av. El Sol 114", city: "Cusco", email: "abellisimo@gmail.com", password: "123456"
)
photo = URI.open("https://cdn-icons-png.flaticon.com/512/1/1247.png")
...
product1 = Product.new(
  category_id: catmaqui.id, name: "Covergirl Base de Maquillaje", old_price: 46.90, discount: 20, price: 37.52, stock: 75,
...
product2 = Product.new(
  category_id: catmaqui.id, name: "Prebase de Maquillaje Master", old_price: 49.90, discount: 15, price: 42.42, stock: 15,
...
product2.photos.attach(io: photo, filename: "product1.png", content_type: "image/png")
product2.save
puts "producto 2,Maquillaje creado"

puts "creando Producto 2 categoria 1"
product3 = Product.new(
  category_id: catmaqui.id, name: "Base de Maquillaje Wear Abc Cushion", old_price: 59.90, discount: 40, price: 35.94,
  stock: 20,
...
product3.photos.attach(io: photo, filename: "product1.png", content_type: "image/png")
product3.save
puts "producto 3,Maquillaje creado"

puts "creando Producto 2 categoria 1"
product4 = Product.new(
  category_id: catmaqui.id, name: "Base de Maquillaje The Healthy ", old_price: 62.90, discount: 40, price: 37.74,
  stock: 15,
...
product4.photos.attach(io: photo, filename: "product4.png", content_type: "image/png")
product4.save
puts "producto 4,Maquillaje creado"

puts "creando Producto 2 categoria 1"
product5 = Product.new(
  category_id: catmaqui.id, name: "Base de Maquillaje Youthful Wear", old_price: 59.90, discount: 40, price: 35.94,
  stock: 15,
...
product6 = Product.new(
  category_id: catmaqui.id, name: "Base de Maquillaje Youthful Wear", old_price: 59.90, discount: 10, price: 35.94,
  stock: 5,
  description: "Base de Maquillaje Youthful Wear Spotless SPF 15 Physicians Formula Medium.",
  user_id: usuario2.id
)
...
product6.photos.attach(io: photo, filename: "product5.png", content_type: "image/png")
product6.save
...
product7 = Product.new(
  category_id: cataba.id, name: "Aceite Vegetal Primor", old_price: 12.19, discount: 6, price: 11.50, stock: 75,
...
product7.photos.attach(io: photo, filename: "product1.png", content_type: "image/png")
product7.save
puts "producto 1,cat Abarrotes creado"

product8 = Product.new(
  category_id: cataba.id, name: "Mayonesa AlaCena 850gr", old_price: 20.70, discount: 28,
...
product8.photos.attach(io: photo, filename: "product7.png", content_type: "image/png")
product8.save
puts "producto 2,cat Abarrotes creado"

product9 = Product.new(
  category_id: cataba.id, name: "Bombones Bon o Bon", old_price: 12, discount: 53,
...
product9.photos.attach(io: photo, filename: "product7.png", content_type: "image/png")
product9.save
puts "producto 3,cat Abarrotes creado"

product10 = Product.new(
  category_id: cataba.id, name: "Turrón San José", old_price: 33.90, discount: 15, price: 28.82, stock: 10,
...
product10.photos.attach(io: photo, filename: "product7.png", content_type: "image/png")
product10.save
puts "producto 4,cat Abarrotes creado"

product11 = Product.new(
  category_id: cataba.id, name: "Trozos de Atún en lata", old_price: 5.40, discount: 20, price: 4.32, stock: 100,
...
product11.photos.attach(io: photo, filename: "product7.png", content_type: "image/png")
product11.save
puts "producto 5,cat Abarrotes creado"

product12 = Product.new(
  category_id: cataba.id, name: "Galletas Morochas", old_price: 4.90, discount: 12, price: 4.20, stock: 70,
...
product12.photos.attach(io: photo, filename: "product7.png", content_type: "image/png")
product12.save
...
product13 = Product.new(
  category_id: catelec.id, name: "Vidaa Smart Tv Uhd 65", old_price: 2499.00, discount: 28, price: 1799.00, stock: 8,
...
product14 = Product.new(
  category_id: catelec.id, name: "Televisor Samsung Smart TV 55", old_price: 2699.00, discount: 44, price: 1499.00,
  stock: 2,
...
product15 = Product.new(
  category_id: catelec.id, name: "Acer Notebook 14 Swift 3", old_price: 3959, discount: 38, price: 402.40,
  stock: 3,
...
product16 = Product.new(
  category_id: catelec.id, name: "Smartphone Samsung Galaxy A22", old_price: 949.00, discount: 26, price: 699.00, stock: 1,
...
product15 = Product.new(
  category_id: catelec.id, name: "Huawei FreeBuds 3i", old_price: 349.00, discount: 43, price: 199.00, stock: 2,
...
product15 = Product.new(
  category_id: catelec.id, name: "Parlante Portátil Lenreu ", old_price: 229.00, discount: 44, price: 129.00, stock: 2,
...
product19 = Product.new(
  category_id: catcuid.id, name: "Toallitas removedoras de maquillaje", old_price: 24.90, discount: 35, price: 16.10,
...
product20 = Product.new(
  category_id: catcuid.id, name: "Hello Antiplaca & Whitening", old_price: 17.90, discount: 8, price: 16.50, stock: 25,
...
product21 = Product.new(
  category_id: catcuid.id, name: "Rembrandt Intense Pasta dientes blanqueadora", old_price: 24.90, discount: 35, price: 16.10,
  stock: 10, expiration_date: "2023/02/22",
...
product22 = Product.new(
  category_id: catcuid.id, name: "Colgate Optic White Advanced", old_price: 28.90, discount: 30, price: 20.20, stock: 44,
...
product23 = Product.new(
  category_id: catcuid.id, name: "Lápiz de blanqueamiento dental blanco óptico", old_price: 12.9, discount: 22, price: 10,
...
product24 = Product.new(
  category_id: catcuid.id, name: "Kit de blanqueamiento dental con bandeja", old_price: 39.90, discount: 40,
...
product100 = Product.new(
  category_id: catlibre.id, name: "Ruido. Un fallo en el juicio humano", old_price: 50.00, discount: 10, price: 40.00,
  stock: 3,
...
product101 = Product.new(
  category_id: catlibre.id, name: "La mirada quieta", old_price: 70.00, discount: 10, price: 60.00, stock: 1,
...
product102 = Product.new(
  category_id: catlibre.id, name: "Cómo evitar la próxima pandemia", old_price: 80.00, discount: 10, price: 70.00,
  stock: 3,
...
product103 = Product.new(
  category_id: catlibre.id, name: "Yo vengo a ofrecer mi corazón", old_price: 90.00, discount: 10, price: 80.00, stock: 5,
...
product104 = Product.new(
  category_id: catlibre.id, name: "¿Ahorrar o gastar?", old_price: 40.00, discount: 10, price: 30.00, stock: 2,
...
product105 = Product.new(
  category_id: catlibre.id, name: "El Tao de Warren Buffett", old_price: 30.00, discount: 10, price: 20.00, stock: 7,
...
product106 = Product.new(
  category_id: catjugue.id, name: "Gran Castillo de Fiesta", old_price: 200.00, discount: 10, price: 180.00, stock: 2,
...
product120 = Product.new(
  category_id: catjugue.id, name: "Juego de Madera Little Tikes", old_price: 200.00, discount: 20, price: 180.00, stock: 4,
...
product107 = Product.new(
  category_id: catjugue.id, name: "Figura de Acción Transformers Cyberverse", old_price: 80.00, discount: 10,
  price: 70.00, stock: 2,
...
product108 = Product.new(
  category_id: catjugue.id, name: "Lanzador de Dardos Nerf Elite 2.0", old_price: 50.00, discount: 10,
...
product109 = Product.new(
  category_id: catjugue.id, name: "Juguete Preescolar Fisher Price Lil", old_price: 50.00, discount: 10, price: 40.00,
...
product110 = Product.new(
  category_id: catjugue.id, name: "Juguete Preescolar Fisher Price Lil", old_price: 50.00, discount: 70, price: 15.00,
